...
See [Reference > VAMAS ISO standard > Data analysis and peak fitting](../reference/vms.md#data-analysis-and-peak-fitting) for an example of converting VAMAS data containing
