...
See [here](https://fairmat-nfdi.github.io/pynxtools-xps/reference/specs.html) for documentation of how this data format is structured and how the example conversion can be run.ye