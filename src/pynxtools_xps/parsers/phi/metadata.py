...
_KEY_MAP: dict[str, str] = {
    ...
    "institution": "vendor",
    "operator": "user_name",
    "analyser_work_fcn": "analyzer_work_function",
    "analyser_retard_gain": "analyzer_retardation_gain",
    ...
    "no_dp_data_cyc": "no_depth_profile_cycles",
    ...
    "spectral_reg_ir_full": "spectral_region_ir_full",
    ...
    "spectral_reg_ir": "spectral_region_ir",
