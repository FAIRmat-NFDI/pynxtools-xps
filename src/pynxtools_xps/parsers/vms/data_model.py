...
class VamasHeader(_XPSDataclass):
...
@dataclass(order=True)
class VamasBlock(_XPSDataclass):
...
@dataclass(order=True)
class ExpVariable(_XPSDataclass):
    label: str = ""
    unit: str = ""


@dataclass(order=True)
class VamasAdditionalParam(_XPSDataclass):
    label: str = ""
    unit: str = ""
    value: float = 0.0
...
@dataclass(order=True)
class OrdinateValue(_XPSDataclass):
